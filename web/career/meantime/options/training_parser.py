...
class TrainingParser:
    ...
    def parse_top(self):
        ...
        # My Code Start
        parser.add_argument('--mode', type=str, choices=['train', 'validate', 'test', 'fake_test', 'tobigs_test', 'test_loss'], help='Determines whether to train/validate/test the model')
        # My Code End
        ...
        # My Code Start
        parser.add_argument('--input_middle_seq', nargs = "+", help = 'This is input', default = None)
        parser.add_argument('--input_middle_num', help = 'This is input', default = 1)
        parser.add_argument('--input_middle_target', nargs = "+", help = 'This is input', default = None)
        parser.add_argument('--input_future_seq', nargs = "+", help = 'This is input', default = None)
        # My Code End
